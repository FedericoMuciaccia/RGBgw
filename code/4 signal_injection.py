...
# TODO valutare la classe Dataset di TensorFlow
dataset.to_netcdf('/storage/users/Muciaccia/data/validation/signal_amplitude_{}.netCDF4'.format(dataset.signal_intensity), format='NETCDF4')
